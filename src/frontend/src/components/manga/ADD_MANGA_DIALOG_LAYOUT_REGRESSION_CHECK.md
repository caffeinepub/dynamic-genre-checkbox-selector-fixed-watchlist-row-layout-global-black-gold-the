...
- [ ] Verify the scrollable body area has a max-height of 400px
...
- [ ] Verify the scrollable body respects the 400px max-height constraint
...
- Body (ScrollArea) is scrollable with `flex-1 min-h-0` and `max-height: 400px` inline style
...
- The 400px max-height constraint on the scrollable body is critical for the layout
